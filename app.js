...
const compItems = [
  ...
  `<p><i class="fas fa-quote-left"></i> Oh I like that one! <i class="fas fa-quote-right"></i></p>`,
  ...
  `<p><i class="fas fa-quote-left"></i> You've got a good eye! <i class="fas fa-quote-right"></i></p>`,
  ...
  `<p><i class="fas fa-quote-left"></i> Stunning! <i class="fas fa-quote-right"></i></p>`,
